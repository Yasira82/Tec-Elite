...
// A proper app Settings page for Elite (modeled on tec-assets' settings): sectioned,
  ...
  return (
    <div>
      ...
      <Section title={s.about} icon="ℹ️">
        ...
        <Row label={s.domain}><span style={{ color: TEC_COLORS.subtext, fontSize: 14 }}>elite.pi</span></Row>
